...
export default async function Page({ params }: { readonly params: Promise<{ appealId: string }> }) {
	...
	const caseData = await fetch(`https://bot.yuudachi.dev/api/appeals/${appealId}`, {
		headers: {
