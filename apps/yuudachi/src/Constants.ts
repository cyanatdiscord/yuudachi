...
export const INTERACTION_SPAM_THRESHOLD = 3;
export const INTERACTION_SPAM_EXPIRE_SECONDS = 10;
export const MENTION_THRESHOLD = 10;
export const MENTION_EXPIRE_SECONDS = 60;
export const ATTACHMENT_SPAM_THRESHOLD = 25;
export const ATTACHMENT_DUPLICATE_THRESHOLD = 3;
export const ATTACHMENT_EXPIRE_SECONDS = 15;

export const ATTACHMENT_FINGERPRINT_FULL_MAX_BYTES = 2 * 1_024 * 1_024;
export const ATTACHMENT_FINGERPRINT_PARTIAL_BYTES = 256 * 1_024;
export const ATTACHMENT_FINGERPRINT_TIMEOUT_MS = 2_500;
export const ATTACHMENT_FINGERPRINT_MAX_PER_MESSAGE = 4;
