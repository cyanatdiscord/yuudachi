...
> Library guides and patterns for the yuudachi Discord bot.

This directory contains documentation for the key libraries and patterns used throughout the codebase. Each guide provides practical examples drawn from actual project code.
