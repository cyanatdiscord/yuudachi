...
- Env vars: `REDISHOST`, `PGHOST`/`PGPORT`/`PGUSER`/`PGPASSWORD`/`PGDB`, `API_JWT_SECRET`, `API_PORT`, `DISCORD_TOKEN`, `SCAM_DOMAIN_WS`/`SCAM_DOMAIN_IDENTITY`, `LOGGER_NAME`, `FINGERPRINT_PRUNING_ENABLED`, `FINGERPRINT_ALLOWED_USER_IDS`.
